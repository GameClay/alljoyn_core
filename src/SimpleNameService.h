/**
 * @file
 * Data structures used for the simple Name Service
 */
...
#ifndef _SIMPLE_NAME_SERVICE_H
#define _SIMPLE_NAME_SERVICE_H

#ifndef __cplusplus
#error Only include SimpleNameService.h in C++ code.
#endif
 ...
 */
class SimpleNameService : public qcc::Thread {
  public:
    /**
     ...
     * @internal
     *
     * @brief Construct a simple name service object.
     */
    SimpleNameService();
     ...
     * @internal
     *
     * @brief Destroy a simple name service object.
     */
    virtual ~SimpleNameService();
  ...
  private:
    /**
     * @brief The IPv4 multicast address for the simple multicast name service.
    ...
    /**
     * @brief The IPv6 multicast address for the simple multicast name service.
     * Should eventually be registered with IANA.
     *
     * @see http://www.iana.org/assignments/multicast-addresses/
     */
    ...
    /**
     * @brief The port number for the simple multicast name service.
     * Should eventually be registered with IANA.
     *
     * @see http://www.iana.org/assignments/multicast-addresses/
     */
     ...
     * simple name service (the daemon's IPv4 address).
     */
     ...
     * simple name service (the daemon's IPv6 address).
    ...
    /**
     * @internal
     * @brief The port assoicated with this instance of the simple name service
     * (the daemon port).
     */
    uint16_t m_port;
...
#endif // _SIMPLE_NAME_SERVICE_IMPL_H
