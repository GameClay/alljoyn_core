...
public class DaemonService extends Service {
    ...
    //
    public static native void runDaemon(Object[] argv, String config);
    // Should be called to release the memory
    public static native void unregisterBTController(BTLiteController btController);
    public static native void registerBTController(BTLiteController btController);
    ...
    private BTLiteTransport mBTLiteTran = null;
    ...
    class DaemonThread extends Thread {
        public void run()
        {
        	registerBTController(mBTLiteTran.getBTLiteController());
    ...
    {
    	mBTLiteTran = new BTLiteTransport(getApplicationContext());
    	//
        ...
        argv.add("--verbosity=7");           // argv[3] set verbosity to LOG_ERR (see qcc/Logger.h)
        mArgv = argv;
        mConfig = "";
