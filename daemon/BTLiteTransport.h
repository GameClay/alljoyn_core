/**
 * @file
 * BTTransportLift is an implementation of  Non-previliged Transport for Bluetooth.
 */
 ...
 ******************************************************************************/
#ifndef _ALLJOYN_BTLITETRANSPORT_H
#define _ALLJOYN_BTLITETRANSPORT_H

#ifndef __cplusplus
#error Only include BTLiteTransport.h in C++ code.
#endif
...
class BTLiteTransport :
  ...
  public:
     ...
     */
    static const char* TransportName()  { return "btlite"; }
     ...
     */
    TransportMask GetTransportMask() const { return TRANSPORT_BLUETOOTH_LITE; }
    ...
    /**
     * Create a Bluetooth RFCOMM based Transport.
     *
     * @param bus  The bus associated with this transport.
     */
    BTLiteTransport(BusAttachment& bus);
    ...
    void SetBTLiteController(BTLiteController* controller) { btController = controller; }
     ...
     *                    - Valid transport is "btlite". All others ignored.
     *                    - Valid keys are:
     ...
     * @return ER_OK
     *
     * @see BTLiteTransport::StartListen
     */
    ...
    qcc::String GetGlobalGUID();

    QStatus FoundName(std::vector<qcc::String>& nameList, qcc::String& guid, qcc::String& busAddr);
  ...
  private:
    ...
    BTLiteController* btController;
    BusAttachment& bus;                            /**< The message bus for this transport */
    std::list<BTLiteEndpoint*> m_endpointList;     /**< List of active endpoints */
